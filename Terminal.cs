    ...
    internal class Terminal
    {
        ...
        static void CreateFlight()
        {
            ...
            while (true)
            {
                ...
                // Get Airline from Flight Number prefix
                ...
                Flight flight;
                if (specialRequest == "CFFT") flight = new CFFTFlight(flightNumber, airline, origin, destination, expectedTime);
                else if (specialRequest == "DDJB") flight = new DDJBFlight(flightNumber, airline, origin, destination, expectedTime);
                else if (specialRequest == "LWTT") flight = new LWTTFlight(flightNumber, airline, origin, destination, expectedTime);
                else flight = new NORMFlight(flightNumber, airline, origin, destination, expectedTime);
